...
- **[Risco]**: Conflito de cliques em elementos do tipo `label` dentro do `q-item` do Quasar.
  - _Mitigação_: Como o `q-item` tem `tag="label"`, o clique nele repassa o evento para o componente de checkbox filho, que já interceptará a mudança via `beforeToggle`.
